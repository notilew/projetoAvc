...
function redirecionaClienteParaDepartamentoTecnologia($cliente)
{
  ...
  echo json_encode(['url' => 'https://chat.avancoinfo.com.br/' . $url], JSON_UNESCAPED_UNICODE);
...
function redirecionaClienteParaDepartamento($colaboradores, $cliente, $curva = null)
{
  ...
  if (! isset($cliente['ticket'])) {
    ...
    if ($curva) {
      ...
      # verificando se o cliente possui prioridade no atendimento
      if (
        ...
        $cliente['conta_contrato'] === '0000851') {
