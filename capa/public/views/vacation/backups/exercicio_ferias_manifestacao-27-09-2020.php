                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" id="periodos" disabled>
                          ...
                          <option id="periodo-3" value="3">1 Período de 16 Dias e 1 Período de 14 Dias</option>
                          <option id="periodo-4" value="4">1 Período de 21 Dias e 1 Período de 9 Dias</option>
                          <option id="periodo-5" value="5">1 Período de 22 Dias e 1 Período de 8 Dias</option>
                          <option id="periodo-7" value="7">1 Período de 23 Dias e 1 Período de 7 Dias</option>
                          <option id="periodo-8" value="8">1 Período de 16 Dias e 2 Períodos de 7 Dias</option>
                          <option id="periodo-9" value="9">1 Período de 14 Dias e 2 Períodos de 8 Dias</option>
