...
<body>
  ...
  <?php include ABS_PATH . 'inc/templates/sidebar.php' ?>
        ...
        <div class="row">
          <div class="col-sm-12">          
            <h3 class="text-center">Desenvolvimento / Qualidade</h3>
            ...
            <table class="table" id="tabela-externo"><!-- painel do externo -->
              ...
              <tbody>
              <?php foreach($paineis['dev-qualidade'] as $devQualidade) : ?>
                <tr>                  
                  <td class="text-center"><?php echo $devQualidade['id']; ?></td>
                  <td class="text-left"><?php echo $devQualidade['nome'] . ' ' . $devQualidade['sobrenome']; ?></td>
                  <td class="text-center"><?php echo $devQualidade['atendimento']; ?></td>
                  <td class="text-center"><?php echo $devQualidade['espera']; ?></td>
                  <td class="text-center"><?php echo $devQualidade['espera_acima_10_min']; ?></td>
                  <td class="text-center"><?php echo $devQualidade['logado']; ?></td>
                </tr>
              <?php endforeach; ?>
              </tbody>
            </table><!-- painel do externo -->
