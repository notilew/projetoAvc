...
function geraRegistro($db, $tabela)
{
  ...
  # verificando se a tabela enviada é a tabela de tickets
  if ($tabela === 'av_tickets') {
    $query = "SELECT id FROM $tabela WHERE ticket = $registro";
  } else {
...
/**
 * gera a mensagem de e-mail de cancelamento do atendimento externo
 * @param - objeto com uma conexão aberta
 ...
 */
function geraMensagemDeEmailDoCancelamentoDoAtendimentoExterno($db, $externo, $endereco, $contato)
{
        ...
        <div class='row'>
          <div class='col-sm-12'>
            <div class='text-left'>
              ...
              <p>Informamos que a visita agendada referente aos dados abaixo foi <strong>cancelada</strong>.</p>
            </div>
          </div>
        </div>
...
/**
 * gera a mensagem de e-mail de alteração do atendimento externo
 * @param - objeto com uma conexão aberta
 * @param - array com os dados de um atendimento externo
 * @param - array com os dados de um endereço
 * @param - array com os dados de um contato
 */
function geraMensagemDeEmailDeAlteracaoDoAtendimentoExterno($db, $externo, $endereco, $contato, $alteracoes)
{
  require_once DIRETORIO_HELPERS . 'datas.php';
  require_once ABS_PATH . '../tickets/database/functions/screen/instrucoes.php';
  ...
  $msg = "
    ...
    <head>
      <meta http-equiv='content-type' content='text/html; charset=utf-8'>
      <title>Atendimento Externo Alterado</title>
    ...
    <body>
      <div class='container-fluid'>
        ...
        <div class='row'>
          <div class='col-sm-12'>
            <div class='text-left'>
              <h2>Atendimento Externo Alterado</h2>
            </div>
          </div>
        </div>
...
/**
 * gera a mensagem de e-mail de cancelamento do atendimento remoto
 * @param - objeto com uma conexão aberta
 * @param - array com os dados do atendimento remoto
 * @param - array com os dados de um contato
 */
function geraMensagemDeEmailDoCancelamentoDoAtendimentoRemoto($db, $remoto, $contato)
{
  require_once DIRETORIO_HELPERS . 'datas.php';
  ...
  # chamando funções que retornam o cnpj, razão social e conta contrato de uma empresa
  $cnpj        = consultaCnpjDaEmpresa($db, $remoto['id_cnpj']);
  $razaoSocial = consultaRazaoSocialDaEmpresa($db, $remoto['id_cnpj']);
  $contrato    = consultaContratoDaEmpresa($db, $remoto['id_cnpj']);
        ...
        <div class='row'>
          <div class='col-sm-12'>
            <div class='text-left'>
              ...
              <p>Informamos que o atendimento remoto referente aos dados abaixo foi <strong>cancelado</strong>.</p>
            </div>
          </div>
        </div>
...
/**
 * gera a mensagem de e-mail de alteração do atendimento remoto
 * @param - objeto com uma conexão aberta
 * @param - array com os dados do atendimento remoto
 * @param - array com os dados de um contato
 */
function geraMensagemDeEmailDeAlteracaoDoAtendimentoRemoto($db, $remoto, $contato, $alteracoes)
{
  require_once DIRETORIO_HELPERS . 'datas.php';
  ...
  $msg .= 
      "<div class='row'>
        <div class='col-sm-12'>
          <div class='text-left'>
            <p>
              Favor entrar em contato pelo <strong><a href='https://novo.avancoinfo.com.br/session/login' target='_blank'>Portal do Cliente</a></strong> (na opção <strong>Via Ticket Chat</strong>), na <strong>data</strong> e <strong>horário</strong> agendados para realização do atendimento.
            </p>
          </div>
        </div>
      </div>
 ...
 * @param - array com os dados de um contato
 */
function geraMensagemDeEmailDoAtendimentoRemoto($db, $remoto, $contato)
{
  require_once DIRETORIO_HELPERS . 'datas.php';
        ...
        <div class='row'>
          <div class='col-sm-12'>
            <div class='text-left'>
              ...
              <p>Segue abaixo os dados para o atendimento remoto agendado.</p>
            </div>
          </div>
        </div>
